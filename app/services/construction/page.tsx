...
import { CheckCircle2, HardHat, Ruler, ShieldCheck, Hammer, ArrowRight, Sparkles } from "lucide-react";

export const metadata = {
  title: "Construction Work in Silchar | Home & Building Construction | Dream Design",
  description: "Trusted construction services in Silchar. From foundation to finishing, we build residential and commercial properties with quality materials.",
  keywords: "construction company silchar, house construction silchar, building contractor silchar, civil construction assam, home builder silchar",
};
...
const features = [
  {
    ...
    desc: "Skilled engineers and architects with 10+ years of local experience.",
  },
  {
    icon: Ruler,
    title: "Precise Planning",
    desc: "Detailed blueprints and material estimation before we start.",
  },
  {
    icon: ShieldCheck,
    title: "Quality Materials",
    desc: "We use only ISI-certified steel and premium grade cement.",
  },
  {
    icon: Hammer,
    title: "On-Time Delivery",
    desc: "Rigorous project management to ensure deadlines are met.",
  },
];
  ...
  return (
    <div className="flex flex-col w-full bg-white dark:bg-zinc-950">
      ...
      <section className="relative min-h-screen flex items-center justify-center text-center overflow-hidden py-20">
        <Image
          src="/projects/3.jpeg"
          alt="RCC Framing and Civil Construction Work in Silchar"
          fill
          sizes="100vw"
        ...
        <div className="container mx-auto px-6 relative z-10 text-white max-w-4xl pt-12">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/20 border border-primary/30 backdrop-blur-md mb-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
            <span className="text-primary text-xs font-bold tracking-widest uppercase">Building Your Dreams</span>
          </div>
          <h1 className="text-6xl md:text-7xl lg:text-8xl font-heading font-bold mb-6 leading-[1.1] animate-in fade-in slide-in-from-bottom-6 duration-1000">
            Construction <br />
            <span className="text-primary italic font-light">That Lasts</span>
          </h1>
          <p className="text-lg md:text-xl text-zinc-300 max-w-2xl mx-auto leading-relaxed mb-10 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-200">
            Build your dream home with Silchar&apos;s most trusted contractors. From solid foundations to premium finishes, we build with precision and integrity.
          </p>
      ...
      <section className="py-24">
        <div className="container mx-auto px-6 text-center max-w-5xl">
          ...
          <h2 className="text-3xl md:text-5xl font-heading font-bold mb-8">Comprehensive Construction Solutions</h2>
          <p className="text-lg text-muted-foreground mb-16 max-w-3xl mx-auto leading-relaxed">
            Dream Design Silchar offers end-to-end civil and structural solutions. Whether it&apos;s a residential villa or a commercial complex, we handle it all with unmatched craftsmanship.
          </p>
          ...
          <div className="relative h-[400px] md:h-[600px] rounded-3xl overflow-hidden shadow-2xl group">
             <Image
              ...
              <div className="absolute bottom-10 left-10 text-left text-white">
                <p className="text-primary font-bold text-sm uppercase mb-2">Ongoing Project</p>
                <h3 className="text-2xl font-bold">Residential Apartments, Meherpur</h3>
              </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-zinc-50 dark:bg-zinc-900/50">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <p className="text-primary font-bold tracking-widest uppercase text-sm mb-4">Why Build With Us</p>
            <h2 className="text-3xl md:text-4xl font-heading font-bold">Built on Trust & Integrity</h2>
          </div>
      ...
      <section className="py-24">
        <div className="container mx-auto px-6 text-center">
          <div className="text-center mb-20">
            <p className="text-primary font-bold tracking-widest uppercase text-sm mb-4">Our Approach</p>
            <h2 className="text-3xl md:text-4xl font-heading font-bold">The Path to Your New Home</h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 relative">
             <div className="hidden md:block absolute top-1/4 left-0 w-full h-[2px] bg-zinc-100 dark:bg-zinc-800 -z-10" />
            {[
              { step: "01", title: "Site Survey", desc: "Thorough assessment of land and structural requirements." },
              { step: "02", title: "Planning", desc: "Detailed architectural blueprints and cost estimations." },
              { step: "03", title: "Construction", desc: "Structural framing, masonry, and civil work execution." },
              { step: "04", title: "Finishing", desc: "Final plastering, flooring, and handover of the keys." },
            ].map((item) => (
      ...
      <section className="py-24 bg-zinc-950 text-white text-center relative overflow-hidden">
        <div className="container mx-auto px-6 relative z-10">
          <h2 className="text-4xl md:text-6xl font-heading font-bold mb-8">Ready to Build?</h2>
          <p className="text-xl text-zinc-400 mb-12 max-w-2xl mx-auto">Get a free site visit and construction estimate from our expert engineers.</p>
          <Button size="lg" className="rounded-full px-12 h-16 text-lg font-bold shadow-2xl shadow-primary/30" asChild>
            <Link href="/contact">Get Free Estimate <ArrowRight className="ml-2 h-5 w-5" /></Link>
          </Button>
        </div>
      </section>
    </div>
